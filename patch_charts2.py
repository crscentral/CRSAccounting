...
# Replace the entire charts_jsx block we added previously
old_block_regex = r'      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">.*?      </div>\n'
...
# Need to find where the old block ends. The old block ends right before Hotel Performance.
